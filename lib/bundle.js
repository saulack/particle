...
const resetGlobalVariables = () => {
  ...
  window.circleArr = [];
    const powerUp = new _circles__WEBPACK_IMPORTED_MODULE_0__["default"](999, 1, 6, 1, 1, 6168, 'power up' )
    circleArr.push(powerUp)
    for (let i = 0; i < 150; i++) {
      let dx = Math.random() * 1.5;
      let dy = Math.random() * 1.5;
      let radius = (1 + Math.random()) * 2;
      circleArr.push(new _circles__WEBPACK_IMPORTED_MODULE_0__["default"](999, 1, radius, dx, dy, i, 'particle'));
    }
